...
chart2 <- ggplot(scatterplot_data, aes(x = female_prison_adm)) +
  ...
  ggtitle("Average Prison Admission Rates (across all counties in the U.S.) from 1990-2016")
chart2
...
chart_3 <- ggplot(data_map, aes(x = long, y = lat, group=group)) + 
  ...
  ggtitle("Distribution of Incarcerated Black Individuals in the U.S. Prison System on a County Level (2016)")
chart_3
